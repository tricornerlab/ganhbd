...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <section class="topmenu ">
        <ul class="flex inline-flex ">
            <li class="list-none p-1">About  |</li>
            <li class="list-none p-1">Advantages |</li>
            <li class="list-none p-1">Program |</li>
            <li class="list-none p-1">Teachers | </li>
            <li class="list-none p-1">Enroll | </li>
            <li class="list-none p-1">Fees | </li>
        </ul>
    </section>
...
{{--                        <a href="javascript:Name();">name</a>--}}
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs" class="underline text-gray-900 dark:text-white">PARASHA</a></div>
                            </div>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    ...
                    <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                        OM School @ <?=date('Y') ?> (release v 2.2)
                    </div>
                </div>
            </div>
        </div>
